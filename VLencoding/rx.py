...
# Path to the folder
folder_path = Path("/home/fberfber/Desktop/app/OCCTrials10012025/paritycheck")
                ...
                for i in range(len(x)):
                    try:
                        ...
                        if encoding: # demodulation with statistical encoding 
                            h = int(round((pixel_height - 12)/6.285)) # demodulation with encoding   
...
hseq, pos   = get_handshake("/home/fberfber/Desktop/app/OCCTrials10012025/paritycheck")
hbits       = decode(hseq)[0]
...
raw_packets, loss_data, end_row     = get_data("/home/fberfber/Desktop/app/OCCTrials10012025/paritycheck", pos[0], pos[1])
